...
\subsubsection{Secret sharing with DPFs}
As explained in section 2.2, it is possible to split a function into two parts that, on their own, do not reveal anything about the function. 
