...
\label{sec:private}
To register a mailbox, a client uploads keys $k_A$ and $k_B$ to each of the servers, from which  it then receives a virtual and physical address for its mailbox.
...
In Express, communication costs were compared to those of Riposte and Pung. To do this, \citet{Eskandarian2021} set up three Google Cloud instances, each with 54 GB of RAM. All three instances ran on the same data center to minimise latency. They were used to evaluate Express, Pung and Riposte (See Table \ref{tab:communication}).
